    ...
    const fetchExistingData = async () => {
      ...
      try {
        ...
        const res = await fetch(
          `${API_BASE}/api/cl-report?${queryParams.toString()}`,
          {
  ...
  const handleSubmit = async () => {
    try {
      ...
      const url = formData.id
        ? `${API_BASE}/api/cl-report/${formData.id}`
        : `${API_BASE}/api/cl-report`;
  ...
  return (
    <div className="form-container" ref={formRef}>
      ...
      <div className="form-section">
        <div className="flex-grid">
          <div className="form-column">
            <div className="section-header">PCI</div>
            {renderInput("", "pci")}
          </div>
          <div className="form-column">
            <div className="section-header">CAG</div>
            {renderInput("", "cag")}
          </div>
          <div className="form-column">
            <div className="section-header">Fast Track</div>
            {renderInput("", "fasttrack")}
          </div>
          <div className="form-column">
      ...
      <div className="form-section">
        <div className="flex-grid">
          <div className="form-column">
            <div className="section-header">นักเทคโนโลยีหัวใจ</div>
            {renderInput("", "tech")}
          </div>
          <div className="form-column">
