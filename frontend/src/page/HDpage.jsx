...
export default function HDpage({ username, wardname, selectedDate, shift }) {
    ...
    const fetchExistingData = async () => {
      ...
      try {
        ...
        const res = await fetch(
          `${API_BASE}/api/hd-report?${queryParams.toString()}`,
          {
  ...
  const handleSubmit = async () => {
    try {
      ...
      const url = formData.id
        ? `${API_BASE}/api/hd-report/${formData.id}`
        : `${API_BASE}/api/hd-report`;
      ...
      <div className="form-section">
        <div className="flex-grid">
          <div className="form-column">
            <div className="section-header">HD</div>
            <div className="horizontal-inputs">
              {renderInput("Acute:", "acute")}
              {renderInput("Chronic:", "chronic")}
              {renderInput("ICU:", "icu")}
              {renderInput("Covid:", "covid")}
            </div>
          </div>

          <div className="form-column">
            <div className="section-header">CAPD</div>
            <div className="horizontal-inputs">
              {renderInput("ยอดบริการ OPD:", "capd_opd")}
              {renderInput("ยอดบริการ IPD:", "capd_ipd")}
            </div>
          </div>
        </div>
      </div>
